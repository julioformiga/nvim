		...
		},
		{
			...
			callback = function()
				...
				map(
					...
					'<cmd>2TermExec cmd="make run" direction=vertical size=50<cr>'
...
map("n", "mk", "<cmd>MakefileMenu<CR>", { desc = "Makefile menu", noremap = true, silent = false })
...
map("i", "<C-PageDown>", "<esc><cmd>BufferLineCycleNext<cr>")
map("i", "<C-PageUp>", "<esc><cmd>BufferLineCyclePrev<cr>")
map("n", "<C-PageDown>", "<cmd>BufferLineCycleNext<cr>")
map("n", "<C-PageUp>", "<cmd>BufferLineCyclePrev<cr>")
map("n", "<A-PageDown>", "<cmd>BufferLineCycleNext<cr>")
map("i", "<A-PageDown>", "<esc><cmd>BufferLineCycleNext<cr>")
map("n", "<A-PageUp>", "<cmd>BufferLineCyclePrev<cr>")
map("i", "<A-PageUp>", "<esc><cmd>BufferLineCyclePrev<cr>")
...
-- Move/Nav arguments
map("n", "<C-h>", "<CMD>SidewaysLeft<CR>")
map("n", "<C-l>", "<CMD>SidewaysRight<CR>")
