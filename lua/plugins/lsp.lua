	...
	},
	{
		...
		opts = {
			formatters_by_ft = {
				...
				python = { "ruff_format" },
				html = { "prettierd", "biome --write" },
				vue = { "prettierd" },
				css = { "prettierd", "biome --write" },
				json = { "prettierd", "biome --write" },
				jsonc = { "prettierd", "biome --write" },
				javascript = { "prettierd", "biome --write" },
				typescript = { "prettierd", "biome --write" },
				typescriptreact = { "prettierd", "biome --write" },
			},
			-- formatters = {
